    ...
    if($validator->fails()) {
     ...
     //    //MAKA FOLDER TERSEBUT AKAN DIBUAT
      ...
      //YANG TELAH DIDEFINISIKAN PADA CONSTRUCTOR
       ...
       $upload = User_admin::find($idd);
       $upload->admFotoProfile = $fileName;
       $upload->admUpdated = date("Y-m-d h:i:s");
       $upload->admUpdatedBy = Auth::user()->admId;
    ...
    if($validator->fails()) {
     ...
     //    //MAKA FOLDER TERSEBUT AKAN DIBUAT
      ...
      //YANG TELAH DIDEFINISIKAN PADA CONSTRUCTOR
       ...
       $upload->ugrUpdated = date("Y-m-d h:i:s");
       $upload->ugrUpdatedBy = Auth::user()->ugrId;

       if($upload->save()){
        $dataArray = array(
          'laIdGuru' =>Auth::user()->ugrId,
          'laNamaUser' => FullNamaGuru(),
          'laNamaAksi' =>'Melakukan Upload Foto Profile',
