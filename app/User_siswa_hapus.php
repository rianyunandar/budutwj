...
class User_siswa_hapus extends Model
{
  protected $table = 'user_siswa_hapus';
  ...
  public function profile_siswa_hapus()
  { 
   return $this->hasOne(Profile_siswa_hapus::class,'psSsaUsername','ssaUsername')->with('master_smp');
