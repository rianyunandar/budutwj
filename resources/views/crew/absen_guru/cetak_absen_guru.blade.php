...
<div class="landscape">
	...
	{{-- <table class='detail' border="0">
		...
		{{-- <tr>
			<td width="170">MATA PELAJARAN</td><td>:</td><td ><span style='width:450px;'>&nbsp; sda</span></td>
			
		</tr>
		<tr>
			<td >KELAS</td><td>:</td><td ><span style='width:450px;'>&nbsp; asdas</span></td>
	...
	<table class='it-grid it-cetak' width='100%' >
      ...
      <tr height=20px>
        ...
        <th colspan="31" width='25%'>BULAN {{ Str::upper($bulan) }}</th>
        <th colspan="4" width='25%'>KETERANGAN</th>
      </tr>
      <tr height=40px>
			<?php for ($i=1; $i <=31 ; $i++) { 
	...
	<div style='padding-left: 50px;'>
		...
		<table border='0' width='100%'>
			<tr>
				...
				<td >Way Jepara, {{ tgl_indo(date('Y-m-d')) }}</td>
			</tr>
			...
			<tr>
				...
				<td class="panjang"><br><br><br><strong>{{ $kepsek->ugrGelarDepan.' '.$kepsek->ugrFirstName.' '.$kepsek->ugrLastName.' '.$kepsek->ugrGelarBelakang }}</strong></td>
			</tr>
			<tr>
				<td></td>
				<td >NIP. {{ $kepsek->profile_guru->prgNip }}</td>
			</tr>
		</table>
	</div>
	<!-- /BAGIAN TANDA TANGGAN -->
