			...
			<div class="col-xl-3 col-sm-6">
				<div class="card">
					...
					<div class="card-body text-center">
						...
						<span class="d-block text-muted">{{ GetHakAkses() }}</span><br>
						{{-- upload foto --}}
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										...
										<input name="namadepan" required value="{{Auth::user()->admFirstName}}" type="text" class="form-control">
									</div>

									<div class="col-md-6">
										<label>Nama Belakang</label>
										<input name="namabelakang" required type="text" value="{{Auth::user()->admLastName}}" class="form-control">
									</div>
								</div>
							</div>
							<hr>
