...
<div class="content">
	...
	<div class="card">
		...
		<div class="card-body">
			<div class="row">
				<div class="col-md-12">
				<form data-route="{{ route('insert.informasi.sekolah') }}" id="insert" enctype="multipart/form-data" >
					@csrf
					<div class="form-group">
						...
						<div class="form-group">
							...
							<input name="judul" type="text" class="form-control" placeholder="Judul Infomasi">
						</div>
						<div class="form-group">
