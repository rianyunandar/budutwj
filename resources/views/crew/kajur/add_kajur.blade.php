	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="row">
				...
				<hr class="mt-1 mb-1"/>
				<form id="insert" data-route="{{ route('insert.kajur') }}">
				{{ csrf_field() }}
				<div class="row">
					<div class="col-md-8">
						<fieldset>
				...
				<div class="text-left">
					...
					<a href="{{ route('lihat.kajur') }}" class="btn bg-slate-600 btn-ladda btn-ladda-progress ladda-button legitRipple ">Kembali</a>
				</div>
			</form>
		</div>
	</div>
