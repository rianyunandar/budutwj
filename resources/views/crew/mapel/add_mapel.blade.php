...
<div class="content">
	...
	<div class="card">
		...
		<div class="card-body">
			<div id="info"></div>
			<form id="insert" method="post" data-route="{{ route('insert.mapel') }}">
				{{ csrf_field() }}
				<div class="row">
					<div class="col-md-8">
						<fieldset>
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<input required type="text" name="kodemapel" class="form-control" placeholder="Kode Mapel">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">Slug Mapel</label>
								<div class="col-lg-9">
									<input required type="text" name="slugmapel" class="form-control" placeholder="Slug Mapel">
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<input required type="text" name="namamapel" class="form-control" placeholder="Nama Mapel">
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<input type="text" name="paketmapel" class="form-control" placeholder="Misal C.1 C.2 ">
								</div>
							</div>
