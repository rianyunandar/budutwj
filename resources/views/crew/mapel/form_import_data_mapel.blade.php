...
<div class="content">
	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="row">
					<div class="col-md-8">{!! $text !!}{{-- <i class="icon-info22 ml-1" data-popup="tooltip" title="Guru Juga Bisa Login Untuk Mengisi atau Melengkapi Data Profile" data-placement="bottom"></i> --}}</div>
				</div>
				<hr class="mt-1 mb-1"/>
			<form id="upload"  data-route="{{ route('import.data.mapel') }}" enctype="multipart/form-data">
				{{ csrf_field() }}
				<div class="row">
					<div class="col-md-8">
						<fieldset>
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<input required type="file" name="import_data_mapel" class="form-control" >
								</div>
							</div>
