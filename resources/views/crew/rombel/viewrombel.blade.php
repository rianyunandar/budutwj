...
<div class="content">
	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="row ">
				<div class="col-md-6">
					<a href="{{ route('tambah.rombel') }}" class="btn btn-primary"><i class="icon-plus3"></i> Tambah Rombel</a>
				</div>
			</div>
			@endif
			<div class="row">
	...
	var tabel = $('#tabel').DataTable({
		...
		{ data: "walikelas",
			render: function(data, type, row, meta) {
				if(data =="kosong"){ return "<span style='color:red'>Belum Ada Wali Kelas</span>"; }
				else{ return data; }
			}
		},
