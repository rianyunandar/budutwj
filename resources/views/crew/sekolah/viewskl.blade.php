...
<div class="content">
	...
	<div class="card">
      ...
      @if(AksiInsert() == true)	
			<div class="row ">
				<div class="col-md-6">
					<a href="{{ route('tambah.sekolah') }}" class="btn btn-primary"><i class="icon-plus3"></i> Tambah Sekolah</a>
				</div>
			</div>
			@endif
			<div class="row">
					...
					<table id="tabel" class="table table-striped table-bordered  datatable-responsive-column-controlled" width="100%">
						<thead style="background-color: #05405a; color: white;">
							<tr>
								...
								<th>KEPEMILIKAN SEKOLAH</th>
								<th>PROVINSI</th>
								<th>KABUPATEN</th>
								<th>KECAMATAN</th>
								<th>EMAIL SEKOLAH</th>
								<th>KAPAN DI UPDATE </th>
							</tr>
						</thead>
						<tbody>
						</tbody>
...
<script type="text/javascript">
	...
	var tabel = $('#tabel').DataTable({
		...
		{ "data": "sklNis",name:"NIS" },
		{ "data": "sklKode",name:"KODE SEKOLAH" },
		{ "data": "sklNama",name:"NAMA SEKOLAH" },
		{ "data": "master_yayasan.msysNama",name:"NAMA YAYASAN" },
		{ "data": "sklAlamat",name:"ALAMAT SEKOLAH" },
		{ "data": "profile_sekolah.prsklStatus",name:"STATUS SEKOLAH" },
		{ "data": "profile_sekolah.prsklKepemilikan",name:"KEPEMILIKAN SEKOLAH" },
		{ "data": "profile_sekolah.prsklProvinsi",name:"PROVINSI" },
		{ "data": "profile_sekolah.prsklKabupaten",name:"KABUPATEN" },
		{ "data": "profile_sekolah.prsklKecamatan",name:"KECAMATAN" },
		{ "data": "sklEmail",name:"EMAIL SEKOLAH" },
		{ "data": "sklUpdated",name:"UPDATE" },
