...
<div class="content">
	...
	<div class="card">
		...
		<div class="card-body">
			<div id="info"></div>
			<form id="addsiswa" method="post" data-route="{{ route('hapus.siswa.by.angkatan') }}">
				{{ csrf_field() }}
				<label>*Pastika sudah yakin dan benar, akan menghapus data siswa yang sudah di jadikan alumni</label><br>
				<label>Jika sudah hapus tidak akan bisa di kembalikan</label>
				<div class="row">
				...
				<div class="text-right">
					<button id="start"   type="submit" class="btn btn-primary ">HAPUS DATA SISWA<i class="icon-paperplane ml-2"></i></button>
