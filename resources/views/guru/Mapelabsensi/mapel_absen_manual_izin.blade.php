...
<div class="content">
	...
	<div class="card">
		...
		<form id="insert"  data-route="{{ route('insert.mapel.absen.izin.guru') }}">
			{{ csrf_field() }}
		...
		<div class="card-body">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left bg-white">
						...
						Pada Menu Izin Absensi, data yang sudah ada akan di Update dan jika data absen tidak ada maka 
						akan di lakukan Tambah data.
					</div>
					<!-- /info alert -->
					<div class="form-group row">
						...
						<div class="col-lg-2">
							<select required data-placeholder="Pilih Absen"  name="status" id="status"  class="form-control select-search" data-fouc>
								<option></option>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						<div class="col-md-12">
						<textarea class="form-control" name="keterangan" id="keterangan" placeholder="Silahkan Isin Keterangan Jika Ada"></textarea>
						</div>
					</div>
				</div>
			</div>
