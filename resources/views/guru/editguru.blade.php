	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="row">
				...
				<hr class="mt-1 mb-1"/>
			<form id="insert" data-route="{{ route('guru.update.data.profile') }}">
				{{ csrf_field() }}
				<div class="row">
					{{-- kolom ke 1 --}}
					<div class="col-md-6">
						<fieldset>
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<select disabled multiple="multiple" required data-placeholder="Pilih Jabatan"  name="jabatan[]" id="jabatan[]"  class="form-control select" data-fouc>
									<option></option>
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<select disabled data-placeholder="Pilih Sekolah"  name="skl" id="skl"  class="form-control select-fixed-single" data-fouc>
									<option></option>
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<select disabled data-placeholder="Pilih PTK"  name="ptk" id="ptk"  class="form-control select-fixed-single" data-fouc>
									<option></option>
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<select disabled data-placeholder="Pilih Status Pegawai"  name="spg" id="spg"  class="form-control select-fixed-single" data-fouc>
									<option></option>
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<input value="{{ $guru->ugrUsername}}" required type="hidden" name="ugrUsername" class="form-control" placeholder="Username Guru">
							...
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">FALKULTAS</label>
								<div class="col-lg-9">
									<input value="{{ $guru->profile_guru->prgFalkultas}}" type="text" name="falkultas" class="form-control" placeholder="Falkultas">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">BIDANG STUDY</label>
								<div class="col-lg-9">
									<input value="{{ $guru->profile_guru->prgBidangStudi}}" type="text" name="bidangstudy" class="form-control" placeholder="Bidang Study">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">KEPENDIDIKAN</label>
								<div class="col-lg-9">
									<select data-placeholder="Pilih Kependidikan"  name="kependidikan" id="kependidikan"  class="form-control select-fixed-single" data-fouc>
										<option ></option>
										<option {{ selectAktif($guru->profile_guru->prgKependidikan,'YA') }} value="YA">YA</option>
										<option {{ selectAktif($guru->profile_guru->prgKependidikan,'TIDAK') }} alue="TIDAK">TIDAK</option>
										</select>
									
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">IPK (mengunakan . contoth 3.00)</label>
								<div class="col-lg-9">
					...
					<div class="col-md-6">
						<fieldset>
							...
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">NIK GURU</label>
								<div class="col-lg-9">
									<input value="{{$guru->profile_guru->prgNip}}" type="text" name="nip" class="form-control" placeholder="NIP GURU">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">NIP GURU</label>
								<div class="col-lg-9">
									<input value="{{$guru->profile_guru->prgNik}}" type="text" name="nik" class="form-control" placeholder="NIK GURU">
								</div>
							</div>
							<div class="form-group row">
				...
				<div class="text-left">
					...
					<a href="{{ route('home.guru') }}" class="btn bg-slate-600 btn-ladda btn-ladda-progress ladda-button legitRipple ">Kembali</a>
				</div>
			</form>
		</div>
	</div>
