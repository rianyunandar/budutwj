...
<div class="content">
	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="row">
				<div class="col-md-12">
				<form data-route="{{ route('update.materi') }}" id="insert" enctype="multipart/form-data" >
					@csrf
					<div class="row">
						<div class="col-md-4">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<input value="{{ $getMateri->materiJudul}}" required name="judul" type="text" class="form-control" placeholder="Judul Materi">
							</div>
						</div>
					</div>
					...
					<div class="row pb-4">
						...
						<div class="col-md-4 pb-2">
							...
							<select required name="status" id="status"  class="form-control select">
								<option {{ selectAktif($getMateri->materiTampil,1) }} value="1">AKTIF</option>
								<option {{ selectAktif($getMateri->materiTampil,0) }} value="0">TIDAK AKTIF</option>
							</select>
						</div>
						<div class="col-md-4 pb-2">
							<label><b>ID Yotube</b></label><br>
							<input value="{{ $getMateri->materiIdYotube}}" name="idyotube" class="form-control" placeholder="Jika ingin membagi video Yotube" />
						</div>
						<div class="col-md-4 pb-2">
							<label><b>Link Url Download File Materi</b></label><br>
							<input value="{{ $getMateri->materiFile}}" name="materifile" class="form-control" placeholder="Seperti Link Google Drive atau Lainya" />
						</div>
					</div>
						...
						<div class="col-md-12">
							<div class="row pb-4">
								<div class="col-md-3">
									...
									<input value="{{ $getMateri->materiKi}}" name="ki" class="form-control" placeholder="1" />
								</div>
								<div class="col-md-3">
									<label><b>KD (Kopentensi Dasar)</b></label><br>
									<input value="{{ $getMateri->materiKd}}" name="kd" class="form-control" placeholder="1.1" />
								</div>
								<div class="col-md-3">
									<label><b>Sub KD (Jika Ada)</b></label><br>
									<input value="{{ $getMateri->materiKdSub}}" name="subkd" class="form-control" placeholder="1.1.1" />
								</div>
								<div class="col-md-3">
									...
									<select  required data-placeholder="Pilih"  name="pertemuan" id="pertemuan"  class="form-control select-search" data-fouc>
										<option ></option>
										@for ($i = 1; $i <= 50; $i++)
											<option {{ selectAktif($getMateri->materiPertemuan,$i) }} value="{{ $i }}" >{{ $i }}</option>
									@endfor
									</select>
								</div>
							</div>
					...
					<div class="row pb-4">
						<div class="col-md-12">
							<textarea name="pesan_singkat" class="form-control" placeholder="Pesan Singkat, Jika ada (100 karakter)" >{{ $getMateri->materiPesanSingkat }}</textarea>
						</div>
					</div>
