...
if(!empty($_GET['skl'])){ 
	$url = 'guru/json-materi?skl='.$getskl.'&kelas='.$getkls.'&mapel='.$getmapel; 
} else{ $url='guru/json-materi';}
...
var tabel = $('#tabel').DataTable({
		...
		{"mRender": function ( data, type, row ) 
			{
				if(row.materiTampil == 1){
					var btn ='<span class="badge badge-success">Tampil</span>';
				}
				else{
					var btn ='<span class="badge badge-danger">Tidak</span>';
				}
				return btn;
			}
		},
				
		{ "data": "materiMapelNama" },
		{ "data": "guru" },
