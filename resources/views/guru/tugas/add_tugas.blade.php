...
<div class="content">
	...
	<div class="card">
		...
		<div class="card-body">
			<div class="row">
				<div class="col-md-12">
				<form data-route="{{ route('insert.tugas.guru') }}" id="insert" enctype="multipart/form-data" >
					@csrf
					<div class="row">
						<div class="col-md-4">
					...
					<div class="row pb-4">
						...
						<div class="col-md-12 pb-2">
							...
							<input name="link_tugas" class="form-control" placeholder="Seperti Link Google Form atau MicrofosForm" />
						</div>
						<div class="col-md-12 pb-2">
							<label><b>Link Url Untuk Download File</b></label><br>
							<input name="link_download" class="form-control" placeholder="Seperti Link Google Drive atau One Drive atau Lainya" />
						</div>
					</div>
						...
						<div class="col-md-12">
							<div class="row pb-4">
								...
								{{-- <div class="col-md-3">
									...
									<select  data-placeholder="Pilih"  name="pertemuan" id="pertemuan"  class="form-control select-search" data-fouc>
										<option ></option>
										@for ($i = 1; $i <= 50; $i++)
