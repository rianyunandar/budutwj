	...
	<div class="text-center d-lg-none w-100 ">
		<div class="d-md-none">
			...
			<div class="d-flex justify-content-center">{{-- agar menu tetap saat ukuran layar mengecil --}}
				...
				<a href="{{ route('edit.akun.siswa')}}" class="btn btn-link btn-float font-size-sm font-weight-semibold text-default">
					<i  class="footer-icon icon-reading text-success"></i>
					<span>AKUN</span>
				</a>
				<a href="{{ route('homeSiswa')}}" class="btn btn-link btn-float font-size-sm font-weight-semibold text-default">
