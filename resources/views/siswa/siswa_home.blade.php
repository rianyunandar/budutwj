      ...
      <div class="col-md-12">
        <!-- Info alert -->
				<div class="alert alert-info alert-styled-left alert-arrow-left bg-white">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Informasi Penting</h6>
          Di mohon kepada siswa untuk dapat melengkapi
          <strong>Biodata</strong> dan <strong>Upload Foto Profile</strong> serta <strong>Ganti Password</strong>
          <br> pada menu <b>akun biodata</b>  
        </div>
			    <!-- /info alert -->
      </div>
    </div>
